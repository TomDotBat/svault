    ...
    cam.Start3D2D(self:LocalToWorld(Vector(-37.2, -32.1, 103.8)), ang, 0.025)
        local offy = 100
        ...
        local tw, th = surface.GetTextSize(vaultname)
        ...
        local sw, sh = surface.GetTextSize(ogl_vault.lang.securitysystem)

        surface.SetFont("OGLBankSecurityMessage")
        local msgw, msgh = surface.GetTextSize(ogl_vault.lang.alertcps)
        ...
        local stw, sth = surface.GetTextSize(timeLeftText)
        ...
        local iw, ih = surface.GetTextSize(ogl_vault.lang.info)
        ...
        local crw, crh = surface.GetTextSize(ogl_vault.lang.currentrobbers)
